...
<body>
        ...
        <div class="filter-section">
            <div class="filter-group">
                ...
                <select id="continent">
                    ...
                    <option value="north-america">Severna Amerika</option>
                    <option value="africa">Afrika</option>
                    <option value="asia">Azija</option>
                    <option value="australia">Avstralija</option>
                </select>
            </div>
        </div>
    </div>
    ...
    <div class="naslovv">
        <h2>REPREZENTANČNI DRESI</h2>
    </div>

    <section class="top-products">
        <div class="product-grid">
            <div class="product" data-size="M,S,L,XL" data-color="yellow,green" data-brand="nike" data-date="2024-10-28" data-continent="south-america">
                <img src="slike/drzave/drzava2.jpg" alt="Brazilija domači dres">
                <p>2002-2003 Brazilija domači dres</p>
                <p>€45,00</p>
                <button class="add-to-cart" onclick="addToCart('2002-2003 Brazilija domači dres', 45, 'slike/drzave/drzava2.jpg')">Dodaj v košarico</button>
            </div>
            <div class="product" data-size="M,S,L,XL" data-color="blue,white" data-brand="adidas" data-date="2024-10-28" data-continent="europe">
                <img src="slike/drzave/drzava3.jpg" alt="Francija domači dres">
                <p>2000-2001 Francija domači dres</p>
                <p>€50,00</p>
                <button class="add-to-cart" onclick="addToCart('2000-2001 Francija domači dres', 50, 'slike/drzave/drzava3.jpg')">Dodaj v košarico</button>
            </div>
            <div class="product" data-size="M,S,L,XL" data-color="blue,black,white" data-brand="adidas" data-date="2025-01-01" data-continent="south-america">
                <img src="slike/drzave/drzava4.jpg" alt="Argentina domači dres">
                <p>1995-1996 Argentina domači dres</p>
                <p>€40,00</p>
                <button class="add-to-cart" onclick="addToCart('1995-1996 Argentina domači dres', 40, 'slike/drzave/drzava4.jpg')">Dodaj v košarico</button>
            </div>
            <div class="product" data-size="M,S,L,XL" data-color="white,red,green" data-brand="nike" data-date="2025-01-01" data-continent="europe">
                <img src="slike/drzave/drzava5.jpg" alt="Portugalska gostujoč dres">
                <p>2011-2012 Portugalska gostujoč dres</p>
                <p>€60,00</p>
                <button class="add-to-cart" onclick="addToCart('2011-2012 Portugalska gostujoč dres', 60, 'slike/drzave/drzava5.jpg')">Dodaj v košarico</button>
            </div>
        </div>
    </section>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            continentFilter.addEventListener('change', filterProducts);
            ...
            function filterProducts() {
                ...
                products.forEach(product => {
                    ...
                    const continent = product.getAttribute('data-continent');
                    ...
                    if (priceMatch && sizeMatch && colorMatch && brandMatch && continentMatch) {
